...
const initialState = {
    ...
    disclaimer: { isLoading: false, iSSuccess: false, isError: "false", data: [], error: "" },
...
const reducer = (state = initialState, action) => {
    ...
    if (action.type === actionTypes.DISCLAIMER_REQUEST) {
        const newState = { ...state };
        newState.disclaimer.isLoading = true;
        newState.disclaimer.iSSuccess = false;
        newState.disclaimer.iSError = false;
        return newState;
    }

    if (action.type === actionTypes.DISCLAIMER_SUCCESS) {
        const newState = { ...state };
        newState.disclaimer.isLoading = false;
        newState.disclaimer.iSSuccess = true;
        newState.disclaimer.iSError = false;
        newState.disclaimer.data = action.payload;
        return newState;
    }

    if (action.type === actionTypes.DISCLAIMER_ERROR) {
        const newState = { ...state };
        newState.disclaimer.isLoading = false;
        newState.disclaimer.iSSuccess = false;
        newState.disclaimer.iSError = true;
        newState.disclaimer.error = action.payload;
        return newState;
    }
